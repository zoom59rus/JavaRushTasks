...
public class Solution {
    ...
    public synchronized String getPartOfString(String string, String threadName) {
        if(threadName.equals(Solution.FIRST_THREAD_NAME)){
            ...
            } else if(!threadName.equals(Solution.FIRST_THREAD_NAME) || !threadName.equals(Solution.SECOND_THREAD_NAME)){
                throw new RuntimeException();
            }
        }

        String tmpString = string.substring(string.indexOf('\t') + 1, string.lastIndexOf('\t'));
        return null;
    }
}
